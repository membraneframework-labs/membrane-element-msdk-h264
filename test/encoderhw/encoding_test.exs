defmodule EncodinghwTest do
  ...
  def make_pipeline(in_path, out_path, width, height, format \\ :I420) do
    Pipeline.start_link(%Pipeline.Options{
      elements: [
        ...
        encoder: %Element.Msdk.H264.Encoderhw{bitrate: 6_000, target_usage: :medium},
  ...
  describe "Large file encoding benchmark" do
    test "30MB Bunny" do
      # in_path = "/home/swm/bbb_sunflower_1080p_30fps_normal.yuv"
      # width = 1920
      # height = 1080
      ...
      assert Pipeline.play(pid) == :ok
      assert_end_of_stream(pid, :sink, :input, 30000000)
    end
  end
end
